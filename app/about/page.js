    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black text-white px-6 py-16">
      ...
      <section className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-gray-400 text-lg max-w-2xl mx-auto">
          BitLinks is a modern URL shortener built for speed, simplicity, and
          performance. We help users create, manage, and track short links
          effortlessly.
        </p>
      </section>
      ...
      <section className="max-w-6xl mx-auto mt-24 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-gray-400">
            Our mission is to simplify link sharing across platforms with
            secure, fast, and reliable redirection technology. We focus on
            clean UI, performance optimization, and developer-friendly
            architecture.
          </p>
        </div>
      ...
      <section className="max-w-6xl mx-auto mt-24 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 text-gray-300">
          ...
          <span className="px-4 py-2 bg-green-600/20 rounded-full">
            MongoDB
          </span>
